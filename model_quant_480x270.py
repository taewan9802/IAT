...
def quantization():
    ...
    dummy_torch_tensor = torch.randn(1, 3, 270, 480, dtype=torch.float32, device='cpu')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_onnx', type=str, default='IAT_quantization_480x270.onnx')
