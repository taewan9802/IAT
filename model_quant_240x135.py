...
def quantization():
    ...
    dummy_torch_tensor = torch.randn(1, 3, 135, 240, dtype=torch.float32, device='cpu')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_onnx', type=str, default='IAT_quantization_240x135.onnx')
